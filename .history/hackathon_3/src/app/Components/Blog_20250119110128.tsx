  ...
  return (
    <section className="px-4 py-8 w-full min-h-screen bg-white select-none">
        ...
        {blog.map((list, index) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col gap-2">
              ...
              <Link href={list.url}>
                <a   className="text-[18px] text-center font-medium text-black font-[poppins] border-b-2  border-black hover:text-gray-500 hover:border-gray-500 transition duration-300">
      ...
      <div className="flex flex-col items-center mt-8">
        <Link href="/">
          <a className="text-[20px] font-medium font-[poppins] text-center text-black border-b-2 border-black hover:text-gray-500 hover:border-gray-500 transition duration-300">
            View All
          </a>
        </Link>
      </div>
